<footer class="py-12 px-6 md:px-12 border-t border-gray-300 text-xs font-medium flex flex-col md:flex-row justify-between items-end">
  <div class="flex flex-col space-y-1 mb-6 md:mb-0">
    <a href="mailto:pietro@firedrop.vc" class="hover:underline">Contact</a>
    <a href="#about" class="hover:underline">About Firedrop</a>
  </div>
  ...
  <div class="flex items-center">
    <svg width="30" height="38" viewBox="0 0 90 115" fill="none" xmlns="http://www.w3.org/2000/svg" class="mr-2">
    ...
    <span class="font-bold text-base tracking-tight">Firedrop</span>
  </div>
</footer>
